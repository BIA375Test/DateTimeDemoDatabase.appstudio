...
const cacheName = 'DateTimeDemoDatabase-2020-10-30 15:27:07.084332'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'DateTimeDemoDatabase'.length) === 'DateTimeDemoDatabase') {
